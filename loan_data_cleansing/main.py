...
hist = model.fit(np.array(x_train), np.array(y_train), epochs=30, batch_size=40,
...
with open("neural_net_model.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
model.save_weights("neural_net_model.h5")
